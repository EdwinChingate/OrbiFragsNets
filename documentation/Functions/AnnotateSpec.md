...
title: AnnotateSpec
kind: function
source: Functions/AnnotateSpec.py
last_updated: 2024-06-08
---

## Description
`AnnotateSpec` orchestrates the MS2 annotation workflow for a single precursor. It generates precursor formula candidates, enumerates fragment candidates, computes chemical-consistency adjacency matrices, builds fragment networks, grades them, and returns the highest-scoring annotation table with chemical formulas.
...
---
## Key operations
- Calls [`MoleculesCand`](../Functions/MoleculesCand.md) on the precursor mass to derive `MaxAtomicSubscripts` for fragments.
- Generates fragment candidates via [`FragSpacePos`](../Functions/FragSpacePos.md), computes the adjacency matrix with [`SelfConsistFrag`](../Functions/SelfConsistFrag.md), and filters peak networks using [`FragNetIntRes`](../Functions/FragNetIntRes.md).
- Builds fragment-level networks via [`IndexLists`](../Functions/IndexLists.md), [`AllNet`](../Functions/AllNet.md), and grades them with [`GradeNet`](../Functions/GradeNet.md).
- Selects the best-scoring network (or multiple when requested), converts candidates to formulas via [`Formula`](../Functions/Formula.md), and optionally saves them.

---
## Parameters
- `SpectrumPeaks`: Peak table from [`MS2Spectrum`](../Functions/MS2Spectrum.md).
- `PrecursorFragmentMass (float)`, `ConfidenceInterval (float)`.
- `SaveAnnotation (bool)`, `NumberofAnnotations`, `MinNumberofAnnotations`: Output controls.

---
## Input
- MS2 peak list and precursor mass.

---
## Output
- `AnSpecDF`: DataFrame containing the selected fragment annotations with formulas, mass errors, confidence intervals, and relative intensities.

---
## Functions
- [`MoleculesCand`](../Functions/MoleculesCand.md)
- [`FragSpacePos`](../Functions/FragSpacePos.md)
- [`SelfConsistFrag`](../Functions/SelfConsistFrag.md)
- [`FragNetIntRes`](../Functions/FragNetIntRes.md)
- [`IndexLists`](../Functions/IndexLists.md)
- [`AllNet`](../Functions/AllNet.md)
- [`GradeNet`](../Functions/GradeNet.md)
